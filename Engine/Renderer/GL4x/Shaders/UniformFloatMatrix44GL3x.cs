...
{
    internal class UniformFloatMatrix44GL4x : Uniform<Matrix4F>, ICleanable
    {
        internal UniformFloatMatrix44GL4x(string name, int location, ICleanableObserver observer)
