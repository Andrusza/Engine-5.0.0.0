...
{
    internal class UniformFloatVector4GL4x : Uniform<Vector4F>, ICleanable
    {
        internal UniformFloatVector4GL4x(string name, int location, ICleanableObserver observer)
