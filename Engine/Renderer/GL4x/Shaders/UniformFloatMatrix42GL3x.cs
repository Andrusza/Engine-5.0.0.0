...
{
    internal class UniformFloatMatrix42GL4x : Uniform<Matrix42<float>>, ICleanable
    {
        internal UniformFloatMatrix42GL4x(string name, int location, ICleanableObserver observer)
