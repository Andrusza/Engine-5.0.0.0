...
{
    internal class UniformFloatMatrix32GL4x : Uniform<Matrix32<float>>, ICleanable
    {
        internal UniformFloatMatrix32GL4x(string name, int location, ICleanableObserver observer)
