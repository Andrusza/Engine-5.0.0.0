...
{
    internal sealed class PixelBufferGL4x : IDisposable
    {
        public PixelBufferGL4x( BufferTarget type, BufferUsageHint usageHint, int sizeInBytes) 
        {
            if (sizeInBytes <= 0)
            {
