...
{
    internal struct ColorAttachmentGL4x
    {
        public Texture2D Texture { get; set; }
        public bool Dirty { get; set; }
    }

    internal class ColorAttachmentsGL4x : ColorAttachments
    {
        public ColorAttachmentsGL4x()
        {
            _colorAttachments = new ColorAttachmentGL4x[Device.MaximumNumberOfColorAttachments];
        }
        ...
        {
            foreach (ColorAttachmentGL4x attachment in _colorAttachments)
            {
        ...
        internal ColorAttachmentGL4x[] Attachments
        {
            get { return _colorAttachments; }
        }

        private ColorAttachmentGL4x[] _colorAttachments;
        private int _count;
    }
}
