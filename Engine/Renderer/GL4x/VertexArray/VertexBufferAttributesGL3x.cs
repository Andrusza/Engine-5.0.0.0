...
{
    internal struct VertexBufferAttributeGL4x
    {
        public VertexBufferAttribute VertexBufferAttribute { get; set; }
        public bool Dirty { get; set; }
    }

    internal class VertexBufferAttributesGL4x : VertexBufferAttributes
    {
        public VertexBufferAttributesGL4x()
	    {
            _attributes = new VertexBufferAttributeGL4x[Device.MaximumNumberOfVertexAttributes];
        }
        ...
        {
            foreach (VertexBufferAttributeGL4x attribute in _attributes)
            {
        ...
        private void Attach(int index)
        {
            ...
            VertexBufferGL4x bufferObjectGL = (VertexBufferGL4x)attribute.VertexBuffer;
        ...
        private VertexBufferAttributeGL4x[] _attributes;
        private int _count;
