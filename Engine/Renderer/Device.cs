...
namespace OpenGlobe.Renderer
{
    ...
    public static class Device
    {
        ...
        {
            return CreateWindow(width, height, title, GameWindowFlags.Default);
        }
        ...
        //private static VertexBuffer CreateVertexBuffer<T>(IList<T> values, BufferUsageHint usageHint) where T : struct
        //{
